...
func (h *Controller) GetCategories(ctx echo.Context) error {
	...
	return ctx.JSON(http.StatusOK, responses.Ok(http.StatusOK, "Successfully fetched Categories", categoriesResponses))
}
